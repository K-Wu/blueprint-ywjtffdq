...
\hatsubsection[\hatx{ver1byXZH 2011-06-14}]{小说三要素:}
\begin{compactdesc}
...
\hatsubsection[\hatx{ver1byXZH 2011-08-04}]{第二人称：}
...
\hatsubsection[\hatx{ver1byXZH 2011-08-04}]{选择句子或词语：}
...
\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{段序(段与段能否互换)：}
\begin{asparaenum}[(1)]
\item 过渡关系(承上启下)；
\item 连接关系(与上下段的关系)；
\item 总分关系；
...
\hatsubsection[\hatb{ver3byXZH 2011-09-26}]{设问（设问句）的作用：}
\begin{compactdesc}
...
\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{省略号用法：}
\begin{asparaenum}[(1)]
\item 表示列举的省略；
\item 表示内容的省略；
\item 表示说话断断续续或含含糊糊、支支吾吾（为了更好表现中心）
\end{asparaenum}

\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{括号的作用：}
补充说明
...
\uwave{\hatm{2011-08-24修辞手法和描写方法}}

\hatsubsubsection{表达效果：}
\uwave{\hatm{2011-08-24修辞手法和描写方法的作用}}

\hatsubsubsection{照应的作用：}
\uwave{\hatm{2011-08-24前后照应，（使）结构严谨，表现中心}}

\hatsubsubsection{作者的思想感情<记叙文>}
\uwave{\hatm{2011-09-26往往在文章结尾出现}}

\hatsubsubsection{安排详略的作用<记叙文>}
\uwave{\hatm{2011-09-26为了更好的表现中心}}

\hatsubsubsection{议论文语言特点-议论文语言严密性：4.10.1}
\uwave{\hatm{2011-09-26}}

\section{记叙文}

\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{记叙文整体感知：}
...
方法：\begin{asparaenum}[(1)]\item 看题目(中心内容／思想意义)；
        \item 圈出评价人或物的词句；
        \item 划出议论句、抒情句、哲理句（反复出现的也要划出来）；
        \item 看开头与结尾(尤其是看(划)结尾部分)：
        \item 看内容与细节描写处；
        \item 看题干
\end{asparaenum}

\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{片段：}
续写：
\begin{asparaenum}[(1)]
\item
\item
...
\hatsubsection[\hatb{ver3byXZH 2011-09-26}]{插叙的作用：}
...
\hatsubsection[\hatx{ver1byXZH 2011-09-26}]{标题的作用：}
\begin{asparaenum}[(1)]
\item 写作特点\\
...
\section{议论文}
\hatsubsection[\hatx{ver4byXZH 2011-09-26}]{议论文整体感知：}
...
\hatsubsubsection[\hatx{ver2byXZH 2011-09-26}]{议论文语言严密性：}
...
\hatsubsection[\hatm{ver4byXZH 2011-09-26}]{说明方法的作用：}
...
\hatsubsection[\hatm{ver2bymyself 2011-06-14}]{说明文的分类：}
有以下两种分类
\\分类一
\begin{compactdesc}
