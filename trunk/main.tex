...
\hatsubsection[\hatb{1}{2011-05-24}]{描写(细分)：}
\begin{compactdesc}
...
\hatsubsection[\hatb{1}{2011-06-14}]{说明方法：}
列数字、举例子、作比较、列图表；下定义、引资料、分类别、打比方

\hatsubsection[\hatb{1}{2011-05-24}]{论据的种类：}
\begin{compactdesc}
...
\hatsubsection[\hatm{1}{2011-06-14}]{选择词语：}
一种是选择能表现人物思想性格的词语(围绕``表现人物的思想性格''来回答)；另一种按照``辨析近义词''的方法进行

\hatsubsection[\hatb{1}{2011-05-25}]{句子的含义：}
...
\hatm{2011-08-24}\uwave{修辞手法和描写方法}

\hatsubsubsection{表达效果：}
\hatm{2011-08-24}\uwave{修辞手法和描写方法的作用}

\hatsubsubsection{照应的作用：}
\hatm{2011-08-24}\uwave{前后照应，（使）结构严谨，表现中心}

\hatsubsubsection{作者的思想感情<记叙文>}
\hatm{2011-09-26}\uwave{往往在文章结尾出现}

\hatsubsubsection{安排详略的作用<记叙文>}
\hatm{2011-09-26}\uwave{为了更好的表现中心}

\hatsubsubsection{议论文语言特点-议论文语言严密性：4.10.1}
\hatm{\uwave{2011-09-26}}
...
\hatsubsection[\hatm{1}{2011-05-24}]{记叙文语言特点：}
...
\hatsubsection[\hatb{1}{2011-05-24}]{论据的作用：}
...
\hatsubsection[\hatb{1}{2011-05-24}]{补充（概括）论据：}
人名（事件名）+紧扣论点（或分论点）+结果

\hatsubsection[\hatm{1}{2011-06-14}]{论证过程(怎样进行论证)(又称文章结构)：}
\begin{asparaenum}[(1)]
...
\hatsubsection[\hatm{2}{2011-06-14}]{说明文语言特点：}
...
\hatsubsection[\hatm{2}{2011-06-14}]{说明文的分类：}
有以下两种分类
\\分类一
\begin{compactdesc}
